...
import com.zhangkun.emos.wx.controller.form.DeleteRoleByIdForm;
import com.zhangkun.emos.wx.controller.form.InsertRoleForm;
import com.zhangkun.emos.wx.controller.form.SearchRoleOwnPermissionForm;
import com.zhangkun.emos.wx.controller.form.UpdateRolePermissionsForm;
import com.zhangkun.emos.wx.db.pojo.TbRole;
import com.zhangkun.emos.wx.exception.EmosException;
import com.zhangkun.emos.wx.service.RoleService;
...
public class RoleController {
    ...
    public R searchAllPermission() {
        ArrayList<HashMap> list = roleService.searchAllPermission();
        return R.ok().put("result", list);
    }
